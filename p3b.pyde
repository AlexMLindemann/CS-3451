    ...
    for j in range(height):
        ...
        for i in range(width):
            ...
            for s in sphere_list: 
                ...
                if curr != None and curr > 0 and curr < minT:  #curr is a list
            ...
            if len(candidates) == 0:
                ...
                pixColor = shade_function(closestHit, ray, s)  
                #print(pixColor)
...
#rayintersectscene class
class rayIntersectScene:
